...
//             await axios.post(`http://localhost:3333/api/v1/auctions/create`, {
//                 emial: user.email,
//                 title: values.title,
//                 image: imageUrl,
//                 userId: user.userId,
//                 startPrice: values.startingPrice,
//                 description: values.description,
//                 endDateTime: `${values.endDate?.toISOString()} ${values.endTime}`,
//                 startDateTime: `${values.startDate?.toISOString()} ${values.startTime}`,
//                 incrementPrice: values.incrementPrice,
//             });
...
//                                     onTimeInputChange={setTimeValue}
//                                 />
//                             </div> */}
//                             {/* <div className="my-2">
//                                 <DatePicker label="Start Date" />
